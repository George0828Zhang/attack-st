...
from fairseq.data.audio.audio_utils import (
    convert_waveform, is_npy_data,  # _get_kaldi_fbank, _get_torchaudio_fbank, 
    is_sf_audio_data
)
import torch
...
def _get_kaldi_fbank(
    ...
    try:
        ...
        from kaldifeat import MelBanksOptions
        from kaldifeat import FrameExtractionOptions
...
def extract_fbank_features(
    ...
    features = _get_kaldi_fbank(_waveform, sample_rate, n_mel_bins).numpy()
    # if features is None:
